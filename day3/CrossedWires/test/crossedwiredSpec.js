...
describe('onSegment', () => {
    it('should be false', () => {
        ...
        expect(linesegments.onSegment(p,q, r)).to.be.false;
    });
    it('should be true', () =>{
         let p = {
            x: 158,
        ...
        expect(linesegments.onSegment(p,q, r)).to.be.true; 
    });
    it('should be true', () =>{
         let p = {
            x: 155,
